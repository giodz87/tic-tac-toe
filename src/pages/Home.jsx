...
export default function Home() {
  ...
  const [playes, setPlayers] = useState(false);
  return (
    <>
      {playes ? (
        <SoloGame />
        ...
        <div className="flex flex-col items-center gap-[32px]">
          ...
          <div className="flex flex-col items-center justify-center gap-[16px]">
            ...
            <button
              ...
              className="font-[Outfit] text-[16px] font-semibold w-[327px] h-[56px] bg-[#31C3BD] rounded-[15px] cursor-pointer shadow-skyblue  "
            >
              NEW GAME (VS PLAYER)
            </button>
          </div>
